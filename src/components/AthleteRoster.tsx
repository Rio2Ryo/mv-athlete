  ...
  const roster = [
    {
      ...
      image: '/images/athlete_placeholder_1.jpg' // Placeholder
    },
    {
      ...
      image: '/images/athlete_placeholder_2.jpg' // Placeholder
    },
    {
      ...
      image: '/images/knockout_logo_placeholder.jpg' // Placeholder
    }
  ];
          ...
          {roster.map((item, index) => (
            <div key={index} className="group relative bg-gray-900 rounded-2xl overflow-hidden border border-gray-800 hover:border-[#4ade80]/50 transition-all duration-300">
              <div className="aspect-[4/3] bg-gray-800 relative overflow-hidden">
                {/* Placeholder for image - using a gradient for now if image is missing */}
                <div className="absolute inset-0 bg-gradient-to-br from-gray-700 to-gray-900 flex items-center justify-center text-gray-500">
                   {/* Ideally replace with actual <img> tag when assets are available */}
                   <span className="text-4xl font-bold opacity-20">{item.name.EN.charAt(0)}</span>
                </div>
